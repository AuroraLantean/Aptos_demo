module publisher::dex_simple {
  ...
  fun get_supply(token_symbol: u64): (u64, u64, vector<u8>) {
    if (token_symbol == SymbolN2DR) (Pool1_usdt, Pool1_n2dr, N2DR_name)
    else if (token_symbol == SymbolAPT) (Pool2_usdt, Pool2_apt, APT_name)
    else (Pool3_usdt, Pool3_weth, WETH_name)
  }
